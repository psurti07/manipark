                        ...
                        <form method="post" class="request-form save-form-1" action="{{ route('self.apply.mega-offer.submit') }}">
                            <div class="row g-2">
                                ...
                                <div class="col-md-12 form-btn">
                                    <button type="submit" id="submit-btn" class="btn btn--theme hover--theme submit-btn r-12">Apply Now</button>
                                </div>
                            </div>
                        </form>
                        <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a>  and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of RupeyFincorp.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-12 col-lg-12">
                        <div class="section-title mb-50">
                            <h2 class="s-28 w-700 mb-2">Going Strong With Stronger Recommendations!</h2>
            ...
            <div class="row justify-content-center">
                <div class="col-md-12 col-lg-12">
                    <div class="section-title text-center mb-50">
                        <h2 class="s-28 w-700 mb-2">Our Happy Customer</h2>
                ...
                <div class="col-12">
                    <div class="form-holder">
                        <div class="contact-form-notice">
                            ...
                            <p class="s-14">
                                <strong>Important Note:</strong> BE AWARE! We ask our customers to make payments ONLY on our website https://rupeyfincorp.com and NOT through any other source, directly or indirectly. Thanks!
                            </p>
                        </div>
                    </div>
                </div>
