            ...
            <div class="row d-flex align-items-center">
                ...
                <div class="col-md-6 col-lg-6 self-apply-form order-1 order-md-2 order-lg-2">
                    <div id="hero-8-form" class="r-20">
                        ...
                        <p class="p-sm mt-3 mb-0 text-start">By submitting the form & proceeding, you agree to the <a href="{{ route('front.terms.conditions') }}" target="_blank" class="text-dark text-decoration-none">Terms</a>  and <a href="{{ route('front.privacy.policy') }}" target="_blank" class="text-dark text-decoration-none"> Privacy Policy</a> of Manipark.</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    <div class="form-holder">
                        <div class="contact-form-notice">
                            ...
                            <p class="s-14">
                                <strong>Important Note:</strong> BE AWARE! We ask our customers to make payments ONLY on our website https://Manipark.com and NOT through any other source, directly or indirectly. Thanks!
                            </p>
                        </div>
                    </div>
                </div>
