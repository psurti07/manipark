        ...
        <div class="row justify-content-center mb-3">
                ...
                <div class="form-holder">
                    <div class="contact-form-notice">
                        <p class="s-12 color--white">
                            ...
                            for a tenure of 6* years with 2% processing fee, the APR will be 11.75%*. RupeyFincorp is
            ...
            <div class="col-12 col-md-4 col-lg-4 col-xl-4">
                <div class="form-holder">
                    <div class="contact-form-notice">
                        <p class="s-12 color--white">
                            <strong class="color--white mb-1 d-block">Disclaimer:</strong> RupeyFincorp is a loan aggregator and is authorized to
                ...
                <div class="form-holder">
                    <div class="contact-form-notice">
                        <p class="s-12 color--white">
                            ...
                            on our
                            website https://rupeyfincorp.com and NOT through any other source, directly or indirectly.
                            Thanks!
                        </p>
                    </div>
                </div>
