                                ...
                                <div class="card-body">
                                                ...
                                                <div class="col-lg-6">
                                                    <div class="d-flex justify-content-between px-2 py-2 bg--blue-300 rounded-pill">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between w-100">
                                                            ...
                                                            <p class="s-14 color--white m-0">
                                                                &#8377;{{ formatePriceIndia(Cookie::get('loan_amount')) }}
                                                            </p>
                                                        </div>
                                                    </div>
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-12 mb-4">
                                            ...
                                            <div class="form-group form-floating">
                                                <input id="pincode" name="pincode" type="text"
                                                    class="form-control name numeric-input mb-0 py-0"
                                        ...
                                        <div class="col-md-6 col-sm-12 mb-4">
                                            ...
                                            <div class="form-group form-floating">
                                                <input id="city" name="city" type="text"
                                                    class="form-control mb-0 py-0" placeholder=""
                                                    value="{{ old('city') }}">
                                        ...
                                        <div class="text-start">
                                            <button type="submit"
                                                class="s-14 btn btn--theme hover--theme submit w-100 r-12"
