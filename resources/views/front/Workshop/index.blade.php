                ...
                <div class="owl-carousel owl-theme testimonials-carousel">
                    ...
                    <div class="review-1 bg--white-100 block-shadow r-08">
                        <div class="review-txt pt-30">
                            ...
                            <p class="p-sm"><i>"Well done Manipark team, your guidance really makes a big difference. Also services are superb"</i></p>
                        </div>
                    </div>
                    <div class="review-1 bg--white-100 block-shadow r-08">
                        <div class="review-txt pt-30">
                    ...
                    <div class="review-1 bg--white-100 block-shadow r-08">
                        <div class="review-txt pt-30">
                            ...
                            <p class="p-sm"><i>“It just went beyond my expectations. It’s so easy to get effective loan consultation with Manipark”</i></p>
                        </div>
                    </div>
                </div>
            </div>
