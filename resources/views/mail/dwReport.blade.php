                                                                ...
                                                                <tbody>
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <h3 style="text-align:center; color: #248c92;font-family: Poppins, sans-serif;">
                                                                            ...
                                                                            <table cellpadding="0" cellspacing="0"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td
                                                                                            style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #EEF6FF; color:#000;font-size:16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                    ...
                                                                    <tr>
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <table width="100%" bgcolor="#ffffff" style="border-radius: 15px; background-color: transparent;margin-bottom:15px;">
                                                                                <tr>
                                                                                    <td style="padding: 0 20px; background-color: #EEF6FF; color: #000; font-size: 16px; border-radius: 12px;font-family: Poppins, sans-serif;">
                                                                                        <table width="100%" style="width: 100%;">
                                                                                            ...
                                                                                            <tr>
                                                                                                <td><h5 style="margin:0">{{ $agent->fullname ?? 'manipark Support' }}</h5></td>
                                                            ...
                                                            <table cellpadding="0" cellspacing="0" class="es-left"
                                                                ...
                                                                <tbody>
                                                                        ...
                                                                        <td class="es-m-p20b" align="left"
                                                                            ...
                                                                            <span style="display:flex; justify-content:center; color: #248c92;font-family: Poppins, sans-serif;">Loan Amount - ₹&nbsp;<strong>{{ formatePriceIndia($offers[0]->loanAmount) }}</strong></span>
                                                                            <hr>
                                                                            <table class="offers-table">
                                                                                ...
                                                                                <tbody>
                                                                                    ...
                                                                                    <tr style="font-family: Poppins, sans-serif;">
                                                                                        ...
                                                                                        <td><img src="https://manage.manipark.com/public/upload/banks/{{ $offer->bank_image }}" alt="{{ $offer->bank_name }}" class="bank-logo"></td>
