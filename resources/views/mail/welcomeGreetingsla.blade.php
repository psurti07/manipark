    ...
    <div class="es-wrapper-color" style="background-color: #f9f9f9;">
        <table class="es-wrapper" width="100%" cellspacing="0" cellpadding="0"
            style="
                ...
                background-image: url(https://manipark.com/assets/images/mail-bgm.png);
                background-color: #f9f9f9;
                "
            background="https://manipark.com/front/images/bg-01.webp">
            <tbody>
                <tr>
                                                                                ...
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <a target="_blank"
                                                                                            ...
                                                                                            <img src="https://manipark.com/public/front/images/logo/logo.png"
                                                                                                alt="Manipark"
                                                                    ...
                                                                    <td class="es-m-p20b" align="left"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="center"
                                                                                        style="padding: 20px; margin: 0; line-height: 2rem;    background-color: #EEF6FF;border-top-right-radius:12px;border-top-left-radius:12px;">
                                                                                        <p
                                                                                            style="font-size:2.2rem;color:#248c92;font-weight:600">
                                                                                            Congratulations!
                                                                                        </p>
                                                                                    </td>
                                                                                </tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td align="left"
                                                        ...
                                                        <table cellpadding="0" cellspacing="0" class="es-left"
                                                            align="left"
                                                            style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: collapse;border-spacing: 0;float: left;background-color: #EEF6FF;border: 1px solid #248c92;  border-radius: 12px; display: block;">
                                                            <tbody>
                                                                <tr>
                                                                    <td class="es-m-p20b" align="left"
                                                                        style="padding: 0; margin: 0; width: 600px;">
                                                                        <h3 style="text-align:center; color: #248c92;">
                                                                            Order Details
                                                                        </h3>
                                                                        <hr>
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            width="100%" bgcolor="#ffffff"
                                                                            style="mso-table-lspace: 0;mso-table-rspace: 0;border-collapse: separate;border-spacing: 0; border-radius: 15px;/* border: 1px solid #248c92; */ background-color: transparent;"
                                                                            role="presentation">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td
                                                                                        style="padding:0  20px; margin: 0; line-height: 1.5rem;background-color: #EEF6FF; color:#000;font-size:16px; border-radius: 12px;">
                                                                    ...
                                                                    <td class="es-m-p20b" align="left"
                                                                        ...
                                                                        <table cellpadding="0" cellspacing="0"
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        style="padding: 20px; margin: 0; line-height: 1.5rem;background-color: #EEF6FF; border-radius:12px;color:#000;font-size:16px">
                                                                                        <p>
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td align="left"
                                                                                        ...
                                                                                        <a href="https://manipark.com/customer/login"
                                                                                    ...
                                                                                    <td align="center"
                                                                                        ...
                                                                                        <p
                                                                                            ...
                                                                                            <a target="_blank"
                                                                                                ...
                                                                                                href="https://manipark.com/privacy-policy">
                                                                                                Privacy Policy
                                                                                            </a>
                                                                                            &nbsp; | &nbsp;
                                                                                            <a target="_blank"
                                                                                                style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                href="https://manipark.com/terms-and-conditions">
                                                                                                Terms &amp; Conditions
                                                                                            </a>
                                                                                            &nbsp; | &nbsp;
                                                                                            <a target="_blank"
                                                                                                style="-webkit-text-size-adjust: none; -ms-text-size-adjust: none; mso-line-height-rule: exactly; text-decoration: none; color: #000f26; font-size: 14px;"
                                                                                                href="https://manipark.com/raise-request">
                                                                                                Raise a request
                                                                                            </a>
                                                                                            &nbsp; | &nbsp;
                                                                                            <a target="_blank"
