    ...
    public function sendOtp(Request $request)
    {
        try {
            ...
            if (!$user || (Cookie::has('user_mobile') && Cookie::get('user_mobile') != $inputs['mobile'])) {
                $keysToKeep = ['XSRF-TOKEN', 'manipark_session', 'utm_campaign', 'utm_medium', 'utm_source'];
        ...
        try {
            ...
            if ($responseCode == 100) {
                ...
                if (!$existingInvoice) {
                    ...
                    /* send email in brevo */
                    sendBrevoHtmlMail2($mailData, 'Congratulations! Payment for Manipark’s Hire Agent plan has been successful.', $sendGreetings, 3, $attachments);
            ...
            if (isset($loanType, $applyId, $orderId) && $loanType !== null && $applyId !== null && $orderId !== null) {
                ...
                if (isset($responsecode) && $responsecode == 100) {
                    ...
                    $fbdata = array(
                        ...
                        'sourceurl' => 'https://manipark.com/loan-agent/paymentSuccess'
                    );
        ...
        try {
            ...
            $request = array(
                ...
                "parameter" => [
                    ...
                    'receiver_vpa' => "cpy.manipark@finobank",
