...
class HomeController extends Controller
{
    ...
    public function storeCareer(Request $request){
        ...
        if($result){
           try {
                $maildata = array(
                    'fullname' => "Manipark HR",
                    'email' => "hr@manipark.com"
                );
                $maildata2 = array(
    ...
    public function testdata(){
       $mailData = array(
        ...
        /* send email in brevo */
        $res = sendBrevoHtmlMail2($mailData, 'Congratulations! Payment Successful for Manipark’s Self-Apply Plan.', $sendGreetings, 3, $attachments);
