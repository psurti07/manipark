            ...
            $data['list'] .= '<div class="col company" data-index="' . $loop . '">
                            <a href="javascript:;" class="in_tool it-1 r-10">
                                <div class="bg--white-100 block-shadow r-10 mb-0">
                                    <img class="img-fluid" src="https://manage.manipark.com/public/upload/banks/'.$bank->bank_image.'" alt="' . $bank->bank_name . '" width="auto">
                                </div>
...
if(!function_exists('sendPaymentGreetings')){
    function sendPaymentGreetings($fullname, $mobile, $email){
        /*if($mobile != '') {
            $smsmessage = "Dear Customer, Congratulations! Your loan application has been successfully submitted. Our Customer Executive will call you shortly. Thanks, Manipark";
            $smsresponse = sendtextSMSobb($mobile, $smsmessage, 'main');
        }*/
        if($email != '') {
            // Send email
            $subject = "Welcome to Manipark";
